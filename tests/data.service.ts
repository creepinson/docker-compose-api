...
export const DeviceArr = [
	'/dev/ttyUSB2:/dev/ttyUSB1223',
	'/dev/ttyUSB1:/dev/ttyUSB1222',
];
...
export const ExposeArr = ['3000', '8000'];
...
export const linksArr = ['db', 'db:database', 'redis'];
...
export const Networks = ['some-network-a', 'some-network-b'];
...
export const restart = ['no', 'always', 'on-failure', 'unless-stopped'];

export const SecretStr = 'my_secret_1';
export const SecretStrArr = ['my_secret', 'my_other_secret'];
...
export const SecOptsStrArr = ['label:user:USER', 'label:role:ROLE'];
...
export const CreateSuccess =
	'The create command is deprecated. Use the up command with the --no-start flag instead.\n';
...
export const CommanderExecKeys: string[] = [
	'_events',
	'_eventsCount',
	'_maxListeners',
	'_closesNeeded',
